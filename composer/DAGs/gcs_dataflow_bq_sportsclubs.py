...
default_args = {
    # Tell airflow to start one day ago, so that it runs as soon as you upload it if days_ago(1)
...
bigQueryLoadingTemporaryDirectory=PATH_TO_TEMP_DIR_ON_GCS
    ...
    run_dataflow_pipeline = DataflowTemplatedJobStartOperator(
        ...
        parameters={
            ...
            "JSONPath": bucket_path + "/data/comp_schema/sportsclubs_schema.json",
            "javascriptTextTransformGcsPath": bucket_path + "/data/comp_schema/sportsclubs_transform.js",
            "inputFilePattern": bucket_path + "/data/batch_data/sportsclubs.csv",
            "outputTable": project_id + ":liveability.sportsclubs",
