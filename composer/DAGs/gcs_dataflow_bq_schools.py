...
bigQueryLoadingTemporaryDirectory=PATH_TO_TEMP_DIR_ON_GCS
    ...
    run_dataflow_pipeline = DataflowTemplatedJobStartOperator(
        ...
        parameters={
            ...
            "JSONPath": bucket_path + "/data/comp_schema/schools_schema.json",
            "javascriptTextTransformGcsPath": bucket_path + "/data/comp_schema/schools_transform.js",
            "inputFilePattern": bucket_path + "/data/batch_data/schools.csv",
            "outputTable": project_id + ":liveability.schools",
