...
bigQueryLoadingTemporaryDirectory=PATH_TO_TEMP_DIR_ON_GCS
    ...
    run_dataflow_pipeline = DataflowTemplatedJobStartOperator(
        ...
        task_id="dataflow_shopping_data",
        ...
        parameters={
            ...
            "JSONPath": bucket_path + "/data/comp_schema/shoppingcentres_schema.json",
            "javascriptTextTransformGcsPath": bucket_path + "/data/comp_schema/shoppingcentres_transform.js",
            "inputFilePattern": bucket_path + "/data/batch_data/shoppingcentres.csv",
            "outputTable": project_id + ":liveability.shoppingcentres",
