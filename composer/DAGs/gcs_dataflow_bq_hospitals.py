...
bigQueryLoadingTemporaryDirectory=PATH_TO_TEMP_DIR_ON_GCS
    ...
    run_dataflow_pipeline = DataflowTemplatedJobStartOperator(
        ...
        task_id="dataflow_hospital_data",
        ...
        parameters={
            ...
            "JSONPath": bucket_path + "/data/comp_schema/hospitals_schema.json",
            "javascriptTextTransformGcsPath": bucket_path + "/data/comp_schema/hospitals_transform.js",
            "inputFilePattern": bucket_path + "/data/batch_data/hospitals.csv",
            "outputTable": project_id + ":liveability.hospitals",
